...
@page { margin: 0; }
	...
	<?php
		...
		$id = $booked['id'];
		$title =  $booked['titel'];
		$Fname = $booked['firstName'];
		$lname = $booked['lastName'];
		$email = $booked['email'];
		$National = $booked['national'];
		$country = $booked['country'];
		$phone = $booked['phone'];
		$room_type = $booked['roomType'];
		$Bed_type = $booked['bed'];
		$Noof_room = $booked['numberOfRoom'];
		$meal_type = $booked['Meal'];
		$cin_date = $booked['wantedAt'];
		$cout_date = $booked['leftAt'];
		$nodays = $booked['numberOfDays'];
	...
	?>
		<header>
			...
			<address >
				<p>YourHOTEL,</p>
				<p>Tema<br>Sohag,<br> Egypt.</p>

			</address>
			<span><img alt="" src="{{url('/')}}assets/img/sun.png"></span>
		</header>
		<article>
			<h1></h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- ahmedmashhor500@gmail.com </p>
			</div>
		</aside>
	</body>
</html>
