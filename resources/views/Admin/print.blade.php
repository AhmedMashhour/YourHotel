...
<html>
        <head>
            <meta charset="utf-8">
            <title>Invoice</title>
            <link rel="{{url('admin')}}/stylesheet" href="style.css">
            <link rel="{{url('admin')}}/license" href="https://www.opensource.org/licenses/mit-license/">
    ...
    @page { margin: 0; }
        ...
        ?>
            ...
            <article>
                <h1>Recipient</h1>
                <address >
                    <p><?php echo $titel.$firstName." ".$lastName ?> <br></p>
                </address>
                <table class="meta">
                    <tr>
            ...
            <aside>
                ...
                <div >
                    <p align="center">Email :- ahmedmashhor500@gmail.com || Phone :- 01123739538</p>
                </div>
            </aside>
        </body>
    </html>
